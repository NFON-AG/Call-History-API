...
**Migration:** Rename all references from `destination_type` to `service` in your client code. The allowed values are: `queue`, `skill`, `ivr`, `group`, `time-control`, `voicemail`.
