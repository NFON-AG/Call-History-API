...
// 4. java GetCallRecordsExample.java
//
// Requirements:
...
public class GetCallRecordsExample {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      String callRecordsJson = getCallRecords(accessToken);
      System.out.println("Call records: " + callRecordsJson);
  ...
  private static String getCallRecords(String accessToken) throws IOException, InterruptedException {
    HttpClient client = HttpClient.newHttpClient();

    HttpRequest request = HttpRequest.newBuilder()
      .uri(URI.create(BASE_URL + "/records?limit=25"))
